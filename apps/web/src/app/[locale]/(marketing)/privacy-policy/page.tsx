...
const sections = [
  {
    ...
    body: "Asia Health Link & Travel connects international patients with hospitals in China and coordinates related travel services. This Privacy Policy explains what personal information we collect, how we use it, who we share it with, and the choices you have. Because we process health-related information, a sensitive category of data, we apply heightened safeguards throughout.",
  },
  {
