...
export const metadata: Metadata = {
  ...
  description: "The terms governing your use of the China Medical and Tourism platform.",
};

const sections = [
  {
    title: "1. Description of Service",
    body: "China Medical and Tourism is a facilitation and coordination service. We connect patients with independent, licensed hospitals and doctors in China, and help coordinate related travel logistics and visa-documentation support. We do not provide medical care, diagnosis, or treatment ourselves.",
  },
  {
