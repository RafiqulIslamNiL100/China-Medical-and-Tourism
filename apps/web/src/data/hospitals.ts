    ...
    reviews: [
      {
        ...
        country: "Nigeria",
        rating: 5,
        text: "From the first email to my flight home, the coordination was flawless. Dr. Li explained everything clearly and the recovery suite was better than some hotels I've stayed in.",
        treatment: "Coronary Angioplasty",
        date: "2026-03-14",
      },
      {
        patientName: "Farrukh T.",
        country: "Uzbekistan",
        rating: 5,
        text: "My case manager Li Wei (a different Li!) checked in every single day. I never felt lost in a foreign hospital system.",
    ...
    reviews: [
      {
        ...
        country: "Kazakhstan",
        rating: 5,
        text: "Dr. Zhou's team was patient and thorough through every step. Having a Russian-speaking coordinator made a huge difference.",
        treatment: "IVF Cycle",
        date: "2026-02-08",
      },
      {
